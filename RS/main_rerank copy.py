...
from models import DLCM, PRM, SetRank, MIR, LightGCN, XGBoostReranker, LLM4Rerank, EnhancedLLM4Rerank
...
def parse_args():
    ...
    parser.add_argument('--llm_heads', default=4, type=int, help='number of attention heads')
    parser.add_argument('--llm_layers', default=3, type=int, help='number of transformer layers')
    parser.add_argument('--llm_ff_dim', default=256, type=int, help='feed-forward dimension')
    
    # Enhanced LLM parameters
    parser.add_argument('--max_time_steps', default=100, type=int, help='maximum time steps for temporal embedding')
    parser.add_argument('--context_dim', default=64, type=int, help='context embedding dimension')
    parser.add_argument('--similarity_threshold', default=0.8, type=float, help='threshold for diversity penalty')
...
if __name__ == '__main__':
    os.environ['CUDA_LAUNCH_BLOCKING'] = '1'  # Add this line to enable CUDA_LAUNCH_BLOCKING
    args = parse_args()
